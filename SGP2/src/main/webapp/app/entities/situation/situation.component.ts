...
export class SituationComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.situationService
      ...
      .subscribe(
        (res: HttpResponse<ISituation[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInSituations(): void {
    this.eventSubscriber = this.eventManager.subscribe('situationListModification', () => this.loadPage());
  }
