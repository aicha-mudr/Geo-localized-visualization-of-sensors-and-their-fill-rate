...
import { PoubelleComponent } from 'app/entities/poubelle/poubelle.component';
...
describe('Component Tests', () => {
  describe('Poubelle Management Component', () => {
    let comp: PoubelleComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PoubelleComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.poubelles && comp.poubelles[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
